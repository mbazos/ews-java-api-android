...
class EwsX509TrustManager implements X509TrustManager
{
	...
	/**
	 * @see com.innovaturelabs.net.ssl.X509TrustManager#checkClientTrusted(java.security.cert.X509Certificate[],String authType)
	 */
	...
	/**
	 * @see com.innovaturelabs.net.ssl.X509TrustManager#checkServerTrusted(java.security.cert.X509Certificate[],String authType)
	 */
